...
<body>
    ...
    include_once '../cursos/carritocompra.php';
        ...
        <nav class="navbar navbar-expand-lg navbar-light  py-3" id="mainNav">
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="../cursos/mostrarCarrito.php?idu=<?php echo $idusuario; ?>">Carrito(<?php if (empty($_SESSION['CARRITO'])) {echo 0; } else { echo count($_SESSION['CARRITO']); }; ?>)</a></li>
                
                        <li class="nav-item"><a class="nav-link" href="index.php?idu=<?php echo $idusuario ?>">Lista de tareas</a></li>
...
?>
        ...
        <div class="container p-4">
            <div class="row">
                <div class="searchdiv">
                    <label for="search">Buscador de tareas </label><input type="text" id="search" class="rounded form-control" style="background-color: rgb(106, 199, 70);">
                </div>
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-body">
