        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5">STUDIFY es una aplicación pensada para ayudar a personas que están en proceso de terminar sus estudios. Para ello cuenta con una lista para que apuntes tus tareas y un listado de cursos a los que te puedes inscribir</p>
